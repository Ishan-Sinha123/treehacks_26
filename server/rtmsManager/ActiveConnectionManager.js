...
export class ActiveConnectionManager {
    ...
    add(streamId, handler) {
        ...
        FileLogger.log(
            `[ActiveConnectionManager] Added handler for ${handler.rtmsType} ${handler.rtmsId} stream ${streamId}`
        );
    }
    ...
    remove(streamId) {
        ...
        if (handler) {
            ...
            FileLogger.log(
                `[ActiveConnectionManager] Removed handler for ${handler.rtmsType} ${handler.rtmsId} stream ${streamId}`
            );
        }
    }
