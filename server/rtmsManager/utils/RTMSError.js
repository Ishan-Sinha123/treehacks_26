...
const ZOOM_STATUS_CODES = {
    ...
    5: {
        ...
        message: 'Meeting not found or ended',
        category: 'meeting',
    },
    6: {
    ...
    8: {
        ...
        message: 'Permission denied - RTMS not enabled',
        category: 'permission',
    },
    9: {
    ...
    10: {
        code: 'SERVER_ERROR',
        message: 'Zoom server error',
        category: 'server',
    },
    11: {
        code: 'SERVICE_UNAVAILABLE',
        message: 'RTMS service temporarily unavailable',
        category: 'server',
    },
    ...
    15: {
        ...
        message: 'Handshake failed - authentication rejected',
        category: 'auth',
    },
    16: {
        code: 'MEDIA_NOT_AVAILABLE',
        message: 'Requested media type not available',
        category: 'media',
    },
    17: {
...
const SDK_ERROR_CODES = {
    NOT_INITIALIZED: {
        ...
        fixes: [
            'Call await RTMSManager.init({...}) before using other methods',
        ],
    ...
    MISSING_CREDENTIALS: {
        ...
        category: 'config',
        causes: [
            'clientId, clientSecret, or secretToken not provided',
            'Credentials object is empty',
        ],
        fixes: [
            'Provide all required credentials in init() config',
    ...
    INVALID_CONFIG: {
        ...
        category: 'config',
        causes: [
            'Configuration object has invalid values',
            'mediaTypes value is out of range',
        ],
        fixes: [
            'Review configuration options in documentation',
            'Use RTMSManager.MEDIA.* constants',
        ],
        docsUrl: 'https://developers.zoom.us/docs/rtms/configuration/',
    },
    CONNECTION_FAILED: {
        ...
        fixes: [
            ...
            'Allow wss:// connections to *.zoom.us',
        ],
        docsUrl: 'https://developers.zoom.us/docs/rtms/troubleshooting/',
    },
    SIGNALING_ERROR: {
    ...
    MEDIA_ERROR: {
        ...
        fixes: [
            'Check requested media types are being shared',
            'Handle media availability events',
        ],
...
export class RTMSError extends Error {
    ...
    constructor(code, message, options = {}) {
        ...
        if (
            options.zoomStatus !== undefined &&
            ZOOM_STATUS_CODES[options.zoomStatus]
        ) {
        ...
        const guidance = ERROR_GUIDANCE[this.category] || {
            ...
            fixes: [
                ...
                'Report issue at https://github.com/zoom/rtms-samples/issues',
            ],
    ...
    static fromZoomStatus(statusCode, context = {}) {
        ...
        if (!info) {
            return new RTMSError(
                'UNKNOWN_STATUS',
                `Unknown Zoom status code: ${statusCode}`,
                {
